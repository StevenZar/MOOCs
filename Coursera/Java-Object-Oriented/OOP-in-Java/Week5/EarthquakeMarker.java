...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	// TODO: Add the method:
	// smaller.compareTo(bigger)			return Negative
	// sameSize.compareTo(otherSameSize)	return 0
	// bigger.compareTo(smaller)			return Positive
	// Note: implement the compareTo(EarthquakeMarker marker) method
	// in the EarthquakeMarker class so that it sorts earthquakes
	// in reverse order of magnitude
	public int compareTo(EarthquakeMarker marker) {
		int order = -1;	// 1 -> Correct Order, -1 -> Inverse Order
